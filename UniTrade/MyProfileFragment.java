...
public class MyProfileFragment extends Fragment {
    ...
    private void showUserData() {
        ...
        if (viewedUser.getAddresses() != null && !viewedUser.getAddresses().isEmpty() && viewedUser.getDefaultAddressIndex() != -1) {
            txtAddress.setText(viewedUser.getAddresses().get(viewedUser.getDefaultAddressIndex()).getAddress());
        } else {
