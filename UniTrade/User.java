...
public class User implements Parcelable {
    ...
    public User(String id, String username, String fullName, String email, String phoneNumber,
                ...
                String bio, long lastEdited, List<Address> addresses, int defaultAddressIndex) {
        this.id = id;
    ...
    public User(String id, String username, String profileImageUrl, double sellerRating,
        ...
        this(id, username, "", "", "", profileImageUrl, sellerRating, userRating, lastSeen, bio, 0, new ArrayList<>(), -1);
    }
    ...
    public int getDefaultAddressIndex() { return defaultAddressIndex; } // NEW
    ...
    public void setDefaultAddressIndex(int defaultAddressIndex) { this.defaultAddressIndex = defaultAddressIndex; } // NEW
    ...
    protected User(Parcel in) {
        ...
        defaultAddressIndex = in.readInt();
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(defaultAddressIndex);
    }
