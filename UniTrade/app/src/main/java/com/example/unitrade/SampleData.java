// C:/Users/User/Documents/UniTrade/app/src/main/java/com/example/unitrade/SampleData.java
...
import java.util.List;public class SampleData {

    // ============================================================
    // 🔥 KEY FIX: Use constant package name, never context.getPackageName()
    // ============================================================
    ...
    public static List<User> generateSampleUsers(Context context) {
        ...
        // Add the missing 'long' argument to each User constructor call
        users.add(new User(
                "u1",
                "michael01",
                ...
                0L // <-- FIX: Added missing long argument
        ));
        ...
        users.add(new User(
                ...
                "Loves collecting cute items. Keeps everything in excellent condition.",
                0L // <-- FIX: Added missing long argument
        ));
        ...
        users.add(new User(
                ...
                "Friendly UM student selling tech gadgets and stationery.",
                0L // <-- FIX: Added missing long argument
        ));
...
public static User getUserById(Context context, String id) {
    ...
    public static List<Product> generateSampleProducts(Context context) {
        ...
        // --- Product Images ---
        List<String> imgSetBasketBall = List.of(
        ...
        List<String> imgSetPolaroidCamera = List.of(
        ...
        List<String> imgSetTextbook = List.of(
        ...
        List<String> imgSetElectricKettle = List.of(
        ...
        List<String> imgSetSushiBento = List.of(
        ...
        List<String> imgSetStationerySet = List.of(
        ...
        List<String> imgSetIphoneXR = List.of(
        ...
        List<String> imgSetHostelTableLamp = List.of(
        ...
        List<String> imgSetMechanicalKeyboard = List.of(
        ...
        List<String> imgSetNikeRunningShoes = List.of(
        ...
        // --- Products ---
        list.add(new Product("p1", "Polaroid Camera", 129.99, imgSetPolaroidCamera,
                description, "Good", 500, "Available", "Hobbies",
                "KK12 Block D", sellerA.getId(), qrUrl));

        list.add(new Product("p2", "Mechanical Keyboard", 89.00, imgSetMechanicalKeyboard,
                description, "Like New", 0, "Available", "Electronics",
                "KK3 Block B", sellerA.getId(), qrUrl));

        list.add(new Product("p3", "iPhone XR", 599.00, imgSetIphoneXR,
                description, "Fair", 27, "Reserved", "Electronics",
                "UM Central Library", sellerA.getId(), qrUrl));

        list.add(new Product("p4", "UM Stationery Set", 15.00, imgSetStationerySet,
                description, "Brand New", 0, "Available", "Stationery",
                "FBA – Business Faculty", sellerB.getId(), qrUrl));

        list.add(new Product("p5", "Nike Running Shoes", 120.00, imgSetNikeRunningShoes,
                description, "Good", 48, "Available", "Fashion",
                "KK11 Block A", sellerA.getId(), qrUrl));

        list.add(new Product("p6", "Hostel Table Lamp", 18.90, imgSetHostelTableLamp,
                description, "Like New", 0, "Available", "Room Essentials",
                "Engineering Faculty", sellerC.getId(), qrUrl));

        list.add(new Product("p7", "Basketball", 25.00, imgSetBasketBall,
                description, "Good", 1, "Sold", "Sports",
                "KK10 Sports Court", sellerB.getId(), qrUrl));

        list.add(new Product("p8", "WIA2001 Textbook", 30.00, imgSetTextbook,
                description, "Fair", 36, "Available", "Textbooks",
                "Computer Science Faculty", sellerA.getId(), qrUrl));

        list.add(new Product("p9", "Electric Kettle", 49.00, imgSetElectricKettle,
                description, "Good", 38, "Available", "Room Essentials",
                "KK9 Block C", sellerC.getId(), qrUrl));

        list.add(new Product("p10", "Sushi Bento", 8.50, imgSetSushiBento,
                description, "Brand New", 0, "Available", "Food",
    ...
    public static List<Review> generateReviewsForUser(Context context, User user) {
        ...
        reviews.add(new Review("r1", alicia,
                "The item arrived as described! Very friendly seller and fast response.",
                5.0, "June 5, 2019", "seller"));

        reviews.add(new Review("r2", michael,
                "Good buyer, smooth transaction and polite!",
                4.5, "Aug 12, 2023", "user"));

        reviews.add(new Review("r3", jonathan,
                "Great seller. Item quality is exactly like described.",
                4.0, "Jan 3, 2024", "seller"));

        reviews.add(new Review("r4", alicia,
                "Good communication and on-time meetup.",
                4.5, "May 15, 2023", "user"));
